...
const SUB_AREA_META: Record<string, { title: string; description: string }> = {
  'ibaraki/tsukuba': {
    title: 'つくばの個室サウナ3選｜紡（TSUMUGI）・KIKI 料金・口コミ比較 | サウナ子',
    description: 'つくばの個室サウナ・プライベートサウナ全3施設を徹底比較。人気No.1の紡（TSUMUGI）12,000円〜、古民家サウナKIKI 6,000円〜。つくば駅・研究学園エリアのセルフロウリュ・カップル利用OK施設の料金プラン・予約方法・口コミを掲載。',
  },
  'tochigi/utsunomiya': {
