...
const SUB_AREA_META: Record<string, { title: string; description: string }> = {
  'ibaraki/tsukuba': {
    title: 'サウナつむぎ（紡）つくば｜料金・予約・口コミ＆周辺の個室サウナ3選 | サウナ子',
    description: 'つくば市で人気No.1のサウナつむぎ（紡・TSUMUGI）の料金プラン・予約方法・口コミ評判を徹底解説。つくば駅周辺の個室サウナ全3施設を比較。カップル利用OK・貸切プラン・セルフロウリュ対応の施設情報を掲載。',
  },
  'tochigi/utsunomiya': {
