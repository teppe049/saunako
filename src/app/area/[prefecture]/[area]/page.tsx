...
const SUB_AREA_META: Record<string, { title: string; description: string }> = {
  'ibaraki/tsukuba': {
    title: 'つくばの個室サウナ おすすめ3選｜サウナつむぎ（紡）の料金・予約・口コミ比較 | サウナ子',
    description: 'つくば市の個室サウナ・プライベートサウナ全3施設を徹底比較。サウナつむぎ（紡・TSUMUGI）の料金プラン・予約方法・口コミ評判をはじめ、カップル利用OK・貸切OKの施設情報を掲載。つくばエリアで人気のプライベートサウナが見つかる。',
  },
  'tochigi/utsunomiya': {
    title: '宇都宮の個室サウナ一覧｜カップルOK・貸切プライベートサウナを比較 | サウナ子',
    description: '宇都宮の個室サウナ・プライベートサウナ全施設を徹底比較。蔵サウナやウツノミヤサウナクラブ本店など人気施設を厳選掲載。カップル利用OK・貸切プラン・料金・口コミ・アクセスで比較して、宇都宮でぴったりの個室サウナが見つかる。',
  },
};
