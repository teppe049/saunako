...
const AREA_META: Record<string, { title: string; description: string }> = {
  ...
  saitama: {
    title: '埼玉の個室サウナ一覧｜大宮・浦和の駅チカ施設を比較 | サウナ子',
    description: '埼玉の個室サウナ・プライベートサウナを大宮・浦和を中心に厳選紹介。カップル利用OK多数・料金比較・アクセス情報を掲載。広々としたコスパ抜群の施設が見つかる。',
  },
  chiba: {
  ...
  gunma: {
    title: '群馬の個室サウナ一覧｜高崎・みなかみの貸切サウナを比較 | サウナ子',
    description: '群馬の個室サウナ・プライベートサウナを探すならサウナ子。高崎・前橋の街なかサウナからみなかみ・赤城山の大自然サウナまで厳選。料金・設備・アクセスを比較。',
  },
  tochigi: {
    title: '栃木の個室サウナ一覧｜那須・日光の貸切サウナを比較 | サウナ子',
    description: '栃木の個室サウナ・プライベートサウナを探すならサウナ子。那須・日光エリアを中心に自然に囲まれた施設を厳選。料金・設備・アクセスを比較。',
  },
  ibaraki: {
    title: '茨城の個室サウナ一覧｜つくば・水戸エリアの施設を比較 | サウナ子',
    description: '茨城の個室サウナ・プライベートサウナを探すならサウナ子。つくば・水戸を中心に、料金・設備・アクセスを比較。あなたにぴったりの個室サウナが見つかる。',
  },
  aichi: {
    title: '愛知の個室サウナ一覧｜名古屋のプライベートサウナを比較 | サウナ子',
    description: '愛知・名古屋の個室サウナを探すならサウナ子。サウナの聖地・名古屋のこだわり施設を厳選。料金・設備・アクセスを比較して、あなたにぴったりの施設が見つかる。',
  },
  fukuoka: {
    title: '福岡の個室サウナ一覧｜博多・天神のプライベートサウナを比較 | サウナ子',
    description: '福岡の個室サウナを探すならサウナ子。博多・天神エリアを中心に、料金・設備・アクセスを比較。九州で人気の個室サウナが見つかる。',
  },
};
